...
namespace TravisCILab
{
    ...
    public class Math
    {
        ...
        {
            Assert.AreEqual(19, Program.Add("9", "10"));
        ...
        public void Subtract_Valid()
        {
            ...
            Assert.AreEqual(1110, Program.Subtract("1113", "3"));
        }
        ...
        public void Multiply_Valid()
        {
            ...
            Assert.AreEqual(0, Program.Multiply("6", "0"));
            Assert.AreEqual(333, Program.Multiply("111", "3"));
        }
        ...
        public void Divide_Valid()
        {
            ...
            Assert.AreEqual(37, Program.Divide("111", "3"));
        }
